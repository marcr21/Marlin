...
#define STRING_CONFIG_H_AUTHOR "marcr21" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.5, -6, -4.75 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   12 // (mm) Z Clearance for Deploy/Stow
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELED_SEGMENT_LENGTH 4 // (mm) Length of all segments (except the last one)
...
#define HOMING_FEEDRATE_MM_M { (2400), (600), (600) }
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X -12201
  #define TOUCH_CALIBRATION_Y   9332
  #define TOUCH_OFFSET_X         362
  #define TOUCH_OFFSET_Y         -28
